...
from src.model_baseline import Model
from src.config import Config
from src.trainer_baseline import Trainer
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--num', default=-1, type=int, help='finetune layer nums')
    ...
    config = Config(args, baseline=True)
